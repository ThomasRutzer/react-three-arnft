...
var ARNftProvider = function ARNftProvider(_ref) {
  var children = _ref.children,
      ...
      cameraParamUrl = _ref.cameraParamUrl,
      workerScriptUrl = _ref.workerScriptUrl,
      onWorkerMessage = _ref.onWorkerMessage;
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        arnft = new ARNft(video.current, gl, camera, onLoaded, onWorkerMessage, cameraParamUrl, workerScriptUrl, interpolationFactor);
